<div class="not-main-page container">
    <form class="py-3" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" name="number_of_trips" class="form-control" value="<?=$car["number_of_trips"]?>">
        </div>
        <div class="input-group mb-3">
            <select name="driver_id" class="form-control">
                <?php foreach ($drivers as $driver): ?>
                    <option value="<?= htmlspecialchars($driver['id']) ?>" 
                        <?= $driver['id'] == $car['driver_id'] ? 'selected' : '' ?>>
        ...
        <div class="input-group mb-3">
            ...
            <input type="type" name="img" class="form-control" value="<?=$car["img"]?>">
        </div>
